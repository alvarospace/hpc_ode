...
__device__ void get_rxn_pres_mod (const double T, const double pres, const double * __restrict__ C, double * __restrict__ pres_mod) {
  ...
  // reaction 38;
  pres_mod[INDEX(4)] = m - 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] - 1.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] - 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.37 * C[INDEX(48)];

  // reaction 42;
  pres_mod[INDEX(5)] = m - 0.27 * shared_temp[threadIdx.x + 3 * blockDim.x] + 2.65 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 2.0 * C[INDEX(26)] - 0.62 * C[INDEX(48)];
  ...
  // reaction 186;
  pres_mod[INDEX(28)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];

  // reaction 204;
  pres_mod[INDEX(29)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];

  // reaction 211;
  pres_mod[INDEX(30)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];

  // reaction 226;
  pres_mod[INDEX(31)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];

  // reaction 229;
  pres_mod[INDEX(32)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];
  ...
  // reaction 268;
  pres_mod[INDEX(35)] = m + 1.0 * shared_temp[threadIdx.x + 3 * blockDim.x] + 5.0 * shared_temp[threadIdx.x + 2 * blockDim.x] + 1.0 * shared_temp[threadIdx.x + 1 * blockDim.x] + 0.5 * shared_temp[threadIdx.x] + 1.0 * C[INDEX(15)] + 2.0 * C[INDEX(26)] - 0.30000000000000004 * C[INDEX(48)];
