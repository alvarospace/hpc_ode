...
void eval_spec_rates (const double * __restrict__ fwd_rates, const double * __restrict__ rev_rates, const double * __restrict__ pres_mod, double * __restrict__ sp_rates, double * __restrict__ dy_N) {
  ...
  //rxn 139
  //sp 10
  sp_rates[10] -= (fwd_rates[139] - rev_rates[138]) * pres_mod[29];
  //sp 28
  sp_rates[28] += (fwd_rates[139] - rev_rates[138]) * pres_mod[29];
  //sp 14
  sp_rates[14] -= (fwd_rates[139] - rev_rates[138]) * pres_mod[29];
  ...
  //rxn 146
  //sp 11
  sp_rates[11] -= (fwd_rates[146] - rev_rates[145]) * pres_mod[30];
  //sp 20
  sp_rates[20] += (fwd_rates[146] - rev_rates[145]) * pres_mod[30];
  //sp 5
  sp_rates[5] -= (fwd_rates[146] - rev_rates[145]) * pres_mod[30];
  ...
  //rxn 157
  //sp 26
  sp_rates[26] += (fwd_rates[157] - rev_rates[156]) * pres_mod[31];
  //sp 12
  sp_rates[12] -= 2.0 * (fwd_rates[157] - rev_rates[156]) * pres_mod[31];
  ...
  //rxn 165
  //sp 16
  sp_rates[16] -= (fwd_rates[165] - rev_rates[164]) * pres_mod[32];
  //sp 1
  sp_rates[1] += (fwd_rates[165] - rev_rates[164]) * pres_mod[32];
  //sp 14
  sp_rates[14] += (fwd_rates[165] - rev_rates[164]) * pres_mod[32];

  //rxn 166
  //sp 16
  sp_rates[16] -= (fwd_rates[166] - rev_rates[165]) * pres_mod[33];
  //sp 1
  sp_rates[1] += (fwd_rates[166] - rev_rates[165]) * pres_mod[33];
  //sp 14
  sp_rates[14] += (fwd_rates[166] - rev_rates[165]) * pres_mod[33];
  ...
  //rxn 173
  //sp 24
  sp_rates[24] -= (fwd_rates[173] - rev_rates[172]) * pres_mod[34];
  //sp 0
  sp_rates[0] += (fwd_rates[173] - rev_rates[172]) * pres_mod[34];
  //sp 22
  sp_rates[22] += (fwd_rates[173] - rev_rates[172]) * pres_mod[34];
  ...
  //rxn 184
  //sp 2
  sp_rates[2] += (fwd_rates[184] - rev_rates[183]) * pres_mod[35];
  //sp 37
  sp_rates[37] -= (fwd_rates[184] - rev_rates[183]) * pres_mod[35];
  //sp 47
  sp_rates[47] += (fwd_rates[184] - rev_rates[183]) * pres_mod[35];
  ...
  //rxn 186
  //sp 2
  sp_rates[2] -= (fwd_rates[186] - rev_rates[185]) * pres_mod[36];
  //sp 35
  sp_rates[35] -= (fwd_rates[186] - rev_rates[185]) * pres_mod[36];
  //sp 36
  sp_rates[36] += (fwd_rates[186] - rev_rates[185]) * pres_mod[36];
  ...
  //rxn 204
  //sp 1
  sp_rates[1] += (fwd_rates[204] - rev_rates[203]) * pres_mod[37];
  //sp 34
  sp_rates[34] -= (fwd_rates[204] - rev_rates[203]) * pres_mod[37];
  //sp 47
  sp_rates[47] += (fwd_rates[204] - rev_rates[203]) * pres_mod[37];
  ...
  //rxn 211
  //sp 1
  sp_rates[1] -= (fwd_rates[211] - rev_rates[210]) * pres_mod[38];
  //sp 35
  sp_rates[35] -= (fwd_rates[211] - rev_rates[210]) * pres_mod[38];
  //sp 38
  sp_rates[38] += (fwd_rates[211] - rev_rates[210]) * pres_mod[38];
  ...
  //rxn 226
  //sp 30
  sp_rates[30] += (fwd_rates[226] - rev_rates[225]) * pres_mod[39];
  //sp 46
  sp_rates[46] -= (fwd_rates[226] - rev_rates[225]) * pres_mod[39];
  //sp 14
  sp_rates[14] += (fwd_rates[226] - rev_rates[225]) * pres_mod[39];
  ...
  //rxn 229
  //sp 40
  sp_rates[40] -= (fwd_rates[229] - rev_rates[228]) * pres_mod[40];
  //sp 1
  sp_rates[1] += (fwd_rates[229] - rev_rates[228]) * pres_mod[40];
  //sp 39
  sp_rates[39] += (fwd_rates[229] - rev_rates[228]) * pres_mod[40];
  ...
  //rxn 236
  //sp 40
  sp_rates[40] -= (fwd_rates[236] - rev_rates[235]) * pres_mod[41];
  //sp 1
  sp_rates[1] -= (fwd_rates[236] - rev_rates[235]) * pres_mod[41];
  //sp 41
  sp_rates[41] = (fwd_rates[236] - rev_rates[235]) * pres_mod[41];
  ...
  //rxn 240
  //sp 9
  sp_rates[9] -= (fwd_rates[240] - rev_rates[239]) * pres_mod[42];
  //sp 42
  sp_rates[42] = (fwd_rates[240] - rev_rates[239]) * pres_mod[42];
  //sp 47
  sp_rates[47] -= (fwd_rates[240] - rev_rates[239]) * pres_mod[42];
  ...
  //rxn 268
  //sp 45
  sp_rates[45] -= (fwd_rates[268] - rev_rates[267]) * pres_mod[43];
  //sp 14
  sp_rates[14] += (fwd_rates[268] - rev_rates[267]) * pres_mod[43];
  //sp 31
  sp_rates[31] += (fwd_rates[268] - rev_rates[267]) * pres_mod[43];
  ...
  //sp 51
  sp_rates[51] = (fwd_rates[284] - rev_rates[282]);
  ...
  //sp 52
  (*dy_N) = (fwd_rates[285] - rev_rates[283]);
  //sp 1
  ...
  //rxn 288
  //sp 0
  sp_rates[0] -= (fwd_rates[288] - rev_rates[285]) * pres_mod[44];
  //sp 9
  sp_rates[9] -= (fwd_rates[288] - rev_rates[285]) * pres_mod[44];
  //sp 12
  sp_rates[12] += (fwd_rates[288] - rev_rates[285]) * pres_mod[44];
  ...
  //rxn 293
  //sp 51
  sp_rates[51] += (fwd_rates[293] - rev_rates[287]);
  //sp 2
  ...
  //sp 52
  (*dy_N) -= (fwd_rates[295] - rev_rates[289]);
  //sp 4
  ...
  //sp 52
  (*dy_N) -= (fwd_rates[298] - rev_rates[290]);
  ...
  //rxn 302
  //sp 52
  (*dy_N) -= fwd_rates[302] * pres_mod[45];
  //sp 13
  sp_rates[13] += fwd_rates[302] * pres_mod[45];
  //sp 14
  sp_rates[14] += fwd_rates[302] * pres_mod[45];

  //rxn 303
  //sp 1
  sp_rates[1] -= (fwd_rates[303] - rev_rates[291]) * pres_mod[46];
  //sp 51
  sp_rates[51] += (fwd_rates[303] - rev_rates[291]) * pres_mod[46];
  //sp 28
  sp_rates[28] -= (fwd_rates[303] - rev_rates[291]) * pres_mod[46];
  ...
  //sp 51
  sp_rates[51] -= (fwd_rates[307] - rev_rates[292]);
  //sp 12
  ...
  //sp 51
  sp_rates[51] -= (fwd_rates[308] - rev_rates[293]);
  //sp 28
  ...
  //sp 51
  sp_rates[51] -= (fwd_rates[309] - rev_rates[294]);
  //sp 4
  ...
  //sp 51
  sp_rates[51] -= (fwd_rates[310] - rev_rates[295]);
  //sp 4
  sp_rates[4] -= (fwd_rates[310] - rev_rates[295]);

  //rxn 311
  //sp 25
  sp_rates[25] -= (fwd_rates[311] - rev_rates[296]) * pres_mod[47];
  //sp 50
  sp_rates[50] = (fwd_rates[311] - rev_rates[296]) * pres_mod[47];
  //sp 12
  sp_rates[12] -= (fwd_rates[311] - rev_rates[296]) * pres_mod[47];

  //rxn 312
  //sp 49
  sp_rates[49] = (fwd_rates[312] - rev_rates[297]);
  //sp 50
  sp_rates[50] -= (fwd_rates[312] - rev_rates[297]);
  //sp 2
  ...
  //sp 50
  sp_rates[50] -= (fwd_rates[313] - rev_rates[298]);
  //sp 49
  ...
  //sp 50
  sp_rates[50] -= (fwd_rates[314] - rev_rates[299]);
  //sp 4
  ...
  //sp 50
  sp_rates[50] += (fwd_rates[315] - rev_rates[300]);
  //sp 6
  ...
  //sp 50
  sp_rates[50] -= (fwd_rates[316] - rev_rates[301]);
  //sp 12
  ...
  //rxn 317
  //sp 24
  sp_rates[24] -= (fwd_rates[317] - rev_rates[302]) * pres_mod[48];
  //sp 49
  sp_rates[49] += (fwd_rates[317] - rev_rates[302]) * pres_mod[48];
  //sp 12
  sp_rates[12] -= (fwd_rates[317] - rev_rates[302]) * pres_mod[48];

  //rxn 318
  //sp 49
  sp_rates[49] -= (fwd_rates[318] - rev_rates[303]);
  //sp 2
  ...
  //rxn 319
  //sp 49
  sp_rates[49] -= (fwd_rates[319] - rev_rates[304]) * pres_mod[49];
  //sp 50
  sp_rates[50] += (fwd_rates[319] - rev_rates[304]) * pres_mod[49];
  //sp 1
  sp_rates[1] -= (fwd_rates[319] - rev_rates[304]) * pres_mod[49];

  //rxn 320
  //sp 49
  sp_rates[49] -= (fwd_rates[320] - rev_rates[305]);
  //sp 12
  ...
  //rxn 321
  //sp 49
  sp_rates[49] -= (fwd_rates[321] - rev_rates[306]);
  //sp 18
  ...
  //sp 50
  sp_rates[50] += (fwd_rates[322] - rev_rates[307]);
  //sp 3
  ...
  //rxn 324
  //sp 49
  sp_rates[49] -= (fwd_rates[324] - rev_rates[308]);
  //sp 12
