...
__device__ void eval_spec_rates (const double * __restrict__ fwd_rates, const double * __restrict__ rev_rates, const double * __restrict__ pres_mod, double * __restrict__ sp_rates, double * __restrict__ dy_N) {
  ...
  //rxn 33
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(33)] - rev_rates[INDEX(33)]) * pres_mod[INDEX(4)];
  //sp 3
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(33)] - rev_rates[INDEX(33)]) * pres_mod[INDEX(4)];
  //sp 6
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(33)] - rev_rates[INDEX(33)]) * pres_mod[INDEX(4)];

  //rxn 34
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(34)] - rev_rates[INDEX(34)]) * pres_mod[INDEX(5)];
  //sp 3
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(34)] - rev_rates[INDEX(34)]) * pres_mod[INDEX(5)];
  //sp 6
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(34)] - rev_rates[INDEX(34)]) * pres_mod[INDEX(5)];

  //rxn 35
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(35)] - rev_rates[INDEX(35)]) * pres_mod[INDEX(6)];
  //sp 3
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(35)] - rev_rates[INDEX(35)]) * pres_mod[INDEX(6)];
  //sp 6
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(35)] - rev_rates[INDEX(35)]) * pres_mod[INDEX(6)];

  //rxn 36
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(36)] - rev_rates[INDEX(36)]) * pres_mod[INDEX(7)];
  //sp 3
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(36)] - rev_rates[INDEX(36)]) * pres_mod[INDEX(7)];
  //sp 6
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(36)] - rev_rates[INDEX(36)]) * pres_mod[INDEX(7)];
  ...
  //sp 0
  shared_temp[threadIdx.x] = (fwd_rates[INDEX(38)] - rev_rates[INDEX(38)]) * pres_mod[INDEX(8)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(38)] - rev_rates[INDEX(38)]) * pres_mod[INDEX(8)];

  //rxn 39
  //sp 0
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(39)] - rev_rates[INDEX(39)]) * pres_mod[INDEX(9)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(39)] - rev_rates[INDEX(39)]) * pres_mod[INDEX(9)];

  //rxn 40
  //sp 0
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(40)] - rev_rates[INDEX(40)]) * pres_mod[INDEX(10)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(40)] - rev_rates[INDEX(40)]) * pres_mod[INDEX(10)];

  //rxn 41
  //sp 0
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(41)] - rev_rates[INDEX(41)]) * pres_mod[INDEX(11)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(41)] - rev_rates[INDEX(41)]) * pres_mod[INDEX(11)];

  //rxn 42
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(42)] - rev_rates[INDEX(42)]) * pres_mod[INDEX(12)];
  //sp 4
  sp_rates[INDEX(4)] -= (fwd_rates[INDEX(42)] - rev_rates[INDEX(42)]) * pres_mod[INDEX(12)];
  //sp 5
  sp_rates[INDEX(5)] = (fwd_rates[INDEX(42)] - rev_rates[INDEX(42)]) * pres_mod[INDEX(12)];
  ...
  //rxn 49
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(49)] - rev_rates[INDEX(49)]) * pres_mod[INDEX(13)];
  //sp 10
  sp_rates[INDEX(10)] -= (fwd_rates[INDEX(49)] - rev_rates[INDEX(49)]) * pres_mod[INDEX(13)];
  //sp 12
  sp_rates[INDEX(12)] += (fwd_rates[INDEX(49)] - rev_rates[INDEX(49)]) * pres_mod[INDEX(13)];
  ...
  //rxn 51
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(51)] - rev_rates[INDEX(51)]) * pres_mod[INDEX(14)];
  //sp 12
  sp_rates[INDEX(12)] -= (fwd_rates[INDEX(51)] - rev_rates[INDEX(51)]) * pres_mod[INDEX(14)];
  //sp 13
  sp_rates[INDEX(13)] += (fwd_rates[INDEX(51)] - rev_rates[INDEX(51)]) * pres_mod[INDEX(14)];
  ...
  //rxn 53
  //sp 16
  sp_rates[INDEX(16)] -= (fwd_rates[INDEX(53)] - rev_rates[INDEX(53)]) * pres_mod[INDEX(15)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(53)] - rev_rates[INDEX(53)]) * pres_mod[INDEX(15)];
  //sp 17
  sp_rates[INDEX(17)] += (fwd_rates[INDEX(53)] - rev_rates[INDEX(53)]) * pres_mod[INDEX(15)];
  ...
  //sp 17
  shared_temp[threadIdx.x + 3 * blockDim.x] = -(fwd_rates[INDEX(55)] - rev_rates[INDEX(55)]) * pres_mod[INDEX(16)];
  //sp 18
  sp_rates[INDEX(18)] += (fwd_rates[INDEX(55)] - rev_rates[INDEX(55)]) * pres_mod[INDEX(16)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(55)] - rev_rates[INDEX(55)]) * pres_mod[INDEX(16)];

  //rxn 56
  //sp 17
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(56)] - rev_rates[INDEX(56)]) * pres_mod[INDEX(17)];
  //sp 19
  sp_rates[INDEX(19)] += (fwd_rates[INDEX(56)] - rev_rates[INDEX(56)]) * pres_mod[INDEX(17)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(56)] - rev_rates[INDEX(56)]) * pres_mod[INDEX(17)];
  ...
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(58)] - rev_rates[INDEX(58)]) * pres_mod[INDEX(18)];
  //sp 18
  shared_temp[threadIdx.x + 2 * blockDim.x] = -(fwd_rates[INDEX(58)] - rev_rates[INDEX(58)]) * pres_mod[INDEX(18)];
  //sp 20
  sp_rates[INDEX(20)] += (fwd_rates[INDEX(58)] - rev_rates[INDEX(58)]) * pres_mod[INDEX(18)];
  ...
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(62)] - rev_rates[INDEX(62)]) * pres_mod[INDEX(19)];
  //sp 19
  shared_temp[threadIdx.x] = -(fwd_rates[INDEX(62)] - rev_rates[INDEX(62)]) * pres_mod[INDEX(19)];
  //sp 20
  sp_rates[INDEX(20)] += (fwd_rates[INDEX(62)] - rev_rates[INDEX(62)]) * pres_mod[INDEX(19)];
  ...
  //rxn 69
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(69)] - rev_rates[INDEX(69)]) * pres_mod[INDEX(20)];
  //sp 21
  sp_rates[INDEX(21)] -= (fwd_rates[INDEX(69)] - rev_rates[INDEX(69)]) * pres_mod[INDEX(20)];
  //sp 22
  sp_rates[INDEX(22)] += (fwd_rates[INDEX(69)] - rev_rates[INDEX(69)]) * pres_mod[INDEX(20)];

  //rxn 70
  sp_rates[INDEX(17)] += shared_temp[threadIdx.x + 3 * blockDim.x];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(70)] - rev_rates[INDEX(70)]) * pres_mod[INDEX(21)];
  //sp 22
  sp_rates[INDEX(22)] -= (fwd_rates[INDEX(70)] - rev_rates[INDEX(70)]) * pres_mod[INDEX(21)];
  //sp 23
  shared_temp[threadIdx.x + 3 * blockDim.x] = (fwd_rates[INDEX(70)] - rev_rates[INDEX(70)]) * pres_mod[INDEX(21)];

  //rxn 71
  //sp 24
  sp_rates[INDEX(24)] += (fwd_rates[INDEX(71)] - rev_rates[INDEX(71)]) * pres_mod[INDEX(22)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(71)] - rev_rates[INDEX(71)]) * pres_mod[INDEX(22)];
  //sp 23
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(71)] - rev_rates[INDEX(71)]) * pres_mod[INDEX(22)];
  ...
  //rxn 73
  //sp 24
  sp_rates[INDEX(24)] -= (fwd_rates[INDEX(73)] - rev_rates[INDEX(73)]) * pres_mod[INDEX(23)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(73)] - rev_rates[INDEX(73)]) * pres_mod[INDEX(23)];
  //sp 25
  sp_rates[INDEX(25)] += (fwd_rates[INDEX(73)] - rev_rates[INDEX(73)]) * pres_mod[INDEX(23)];
  ...
  //sp 25
  shared_temp[threadIdx.x + 2 * blockDim.x] = -(fwd_rates[INDEX(75)] - rev_rates[INDEX(75)]) * pres_mod[INDEX(24)];
  //sp 26
  sp_rates[INDEX(26)] += (fwd_rates[INDEX(75)] - rev_rates[INDEX(75)]) * pres_mod[INDEX(24)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(75)] - rev_rates[INDEX(75)]) * pres_mod[INDEX(24)];
  ...
  //rxn 82
  //sp 0
  sp_rates[INDEX(0)] -= (fwd_rates[INDEX(82)] - rev_rates[INDEX(82)]) * pres_mod[INDEX(25)];
  //sp 17
  sp_rates[INDEX(17)] += (fwd_rates[INDEX(82)] - rev_rates[INDEX(82)]) * pres_mod[INDEX(25)];
  //sp 14
  sp_rates[INDEX(14)] -= (fwd_rates[INDEX(82)] - rev_rates[INDEX(82)]) * pres_mod[INDEX(25)];
  ...
  //rxn 84
  //sp 4
  shared_temp[threadIdx.x + 3 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(84)] - rev_rates[INDEX(84)]) * pres_mod[INDEX(26)];
  //sp 7
  sp_rates[INDEX(7)] += (fwd_rates[INDEX(84)] - rev_rates[INDEX(84)]) * pres_mod[INDEX(26)];
  ...
  sp_rates[INDEX(6)] += shared_temp[threadIdx.x];
  //sp 20
  sp_rates[INDEX(20)] += (fwd_rates[INDEX(94)] - rev_rates[INDEX(94)]) * pres_mod[INDEX(27)];
  //sp 12
  shared_temp[threadIdx.x] = -(fwd_rates[INDEX(94)] - rev_rates[INDEX(94)]) * pres_mod[INDEX(27)];
  //sp 4
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(94)] - rev_rates[INDEX(94)]) * pres_mod[INDEX(27)];
  ...
  //rxn 130
  //sp 9
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(130)] - rev_rates[INDEX(130)]) * pres_mod[INDEX(28)];
  //sp 27
  sp_rates[INDEX(27)] += (fwd_rates[INDEX(130)] - rev_rates[INDEX(130)]) * pres_mod[INDEX(28)];
  //sp 14
  sp_rates[INDEX(14)] -= (fwd_rates[INDEX(130)] - rev_rates[INDEX(130)]) * pres_mod[INDEX(28)];
  ...
  //rxn 139
  //sp 10
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(139)] - rev_rates[INDEX(138)]) * pres_mod[INDEX(29)];
  //sp 28
  sp_rates[INDEX(28)] += (fwd_rates[INDEX(139)] - rev_rates[INDEX(138)]) * pres_mod[INDEX(29)];
  //sp 14
  sp_rates[INDEX(14)] -= (fwd_rates[INDEX(139)] - rev_rates[INDEX(138)]) * pres_mod[INDEX(29)];
  ...
  //rxn 146
  //sp 11
  shared_temp[threadIdx.x] -= (fwd_rates[INDEX(146)] - rev_rates[INDEX(145)]) * pres_mod[INDEX(30)];
  //sp 20
  sp_rates[INDEX(20)] += (fwd_rates[INDEX(146)] - rev_rates[INDEX(145)]) * pres_mod[INDEX(30)];
  //sp 5
  sp_rates[INDEX(5)] -= (fwd_rates[INDEX(146)] - rev_rates[INDEX(145)]) * pres_mod[INDEX(30)];
  ...
  //rxn 157
  //sp 26
  sp_rates[INDEX(26)] += (fwd_rates[INDEX(157)] - rev_rates[INDEX(156)]) * pres_mod[INDEX(31)];
  //sp 12
  shared_temp[threadIdx.x + 2 * blockDim.x] -= 2.0 * (fwd_rates[INDEX(157)] - rev_rates[INDEX(156)]) * pres_mod[INDEX(31)];
  ...
  //sp 16
  shared_temp[threadIdx.x] = -(fwd_rates[INDEX(165)] - rev_rates[INDEX(164)]) * pres_mod[INDEX(32)];
  //sp 1
  shared_temp[threadIdx.x + 3 * blockDim.x] += (fwd_rates[INDEX(165)] - rev_rates[INDEX(164)]) * pres_mod[INDEX(32)];
  //sp 14
  sp_rates[INDEX(14)] += (fwd_rates[INDEX(165)] - rev_rates[INDEX(164)]) * pres_mod[INDEX(32)];

  //rxn 166
  //sp 16
  shared_temp[threadIdx.x] -= (fwd_rates[INDEX(166)] - rev_rates[INDEX(165)]) * pres_mod[INDEX(33)];
  //sp 1
  shared_temp[threadIdx.x + 3 * blockDim.x] += (fwd_rates[INDEX(166)] - rev_rates[INDEX(165)]) * pres_mod[INDEX(33)];
  //sp 14
  sp_rates[INDEX(14)] += (fwd_rates[INDEX(166)] - rev_rates[INDEX(165)]) * pres_mod[INDEX(33)];
  ...
  //rxn 173
  //sp 24
  sp_rates[INDEX(24)] -= (fwd_rates[INDEX(173)] - rev_rates[INDEX(172)]) * pres_mod[INDEX(34)];
  //sp 0
  sp_rates[INDEX(0)] += (fwd_rates[INDEX(173)] - rev_rates[INDEX(172)]) * pres_mod[INDEX(34)];
  //sp 22
  sp_rates[INDEX(22)] += (fwd_rates[INDEX(173)] - rev_rates[INDEX(172)]) * pres_mod[INDEX(34)];
  ...
  //rxn 184
  //sp 2
  sp_rates[INDEX(2)] += (fwd_rates[INDEX(184)] - rev_rates[INDEX(183)]) * pres_mod[INDEX(35)];
  //sp 37
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(184)] - rev_rates[INDEX(183)]) * pres_mod[INDEX(35)];
  //sp 47
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(184)] - rev_rates[INDEX(183)]) * pres_mod[INDEX(35)];
  ...
  //rxn 186
  //sp 2
  sp_rates[INDEX(2)] -= (fwd_rates[INDEX(186)] - rev_rates[INDEX(185)]) * pres_mod[INDEX(36)];
  //sp 35
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(186)] - rev_rates[INDEX(185)]) * pres_mod[INDEX(36)];
  //sp 36
  shared_temp[threadIdx.x + 2 * blockDim.x] += (fwd_rates[INDEX(186)] - rev_rates[INDEX(185)]) * pres_mod[INDEX(36)];
  ...
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] += (fwd_rates[INDEX(204)] - rev_rates[INDEX(203)]) * pres_mod[INDEX(37)];
  //sp 34
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(204)] - rev_rates[INDEX(203)]) * pres_mod[INDEX(37)];
  //sp 47
  shared_temp[threadIdx.x] = (fwd_rates[INDEX(204)] - rev_rates[INDEX(203)]) * pres_mod[INDEX(37)];
  ...
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(211)] - rev_rates[INDEX(210)]) * pres_mod[INDEX(38)];
  //sp 35
  shared_temp[threadIdx.x + 2 * blockDim.x] = -(fwd_rates[INDEX(211)] - rev_rates[INDEX(210)]) * pres_mod[INDEX(38)];
  //sp 38
  sp_rates[INDEX(38)] += (fwd_rates[INDEX(211)] - rev_rates[INDEX(210)]) * pres_mod[INDEX(38)];
  ...
  //rxn 226
  //sp 30
  sp_rates[INDEX(30)] += (fwd_rates[INDEX(226)] - rev_rates[INDEX(225)]) * pres_mod[INDEX(39)];
  //sp 46
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(226)] - rev_rates[INDEX(225)]) * pres_mod[INDEX(39)];
  //sp 14
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(226)] - rev_rates[INDEX(225)]) * pres_mod[INDEX(39)];
  ...
  //sp 40
  shared_temp[threadIdx.x] = -(fwd_rates[INDEX(229)] - rev_rates[INDEX(228)]) * pres_mod[INDEX(40)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] += (fwd_rates[INDEX(229)] - rev_rates[INDEX(228)]) * pres_mod[INDEX(40)];
  //sp 39
  sp_rates[INDEX(39)] += (fwd_rates[INDEX(229)] - rev_rates[INDEX(228)]) * pres_mod[INDEX(40)];
  ...
  //rxn 236
  //sp 40
  shared_temp[threadIdx.x] -= (fwd_rates[INDEX(236)] - rev_rates[INDEX(235)]) * pres_mod[INDEX(41)];
  //sp 1
  sp_rates[INDEX(1)] -= (fwd_rates[INDEX(236)] - rev_rates[INDEX(235)]) * pres_mod[INDEX(41)];
  //sp 41
  sp_rates[INDEX(41)] = (fwd_rates[INDEX(236)] - rev_rates[INDEX(235)]) * pres_mod[INDEX(41)];
  ...
  //rxn 240
  //sp 9
  sp_rates[INDEX(9)] -= (fwd_rates[INDEX(240)] - rev_rates[INDEX(239)]) * pres_mod[INDEX(42)];
  //sp 42
  sp_rates[INDEX(42)] = (fwd_rates[INDEX(240)] - rev_rates[INDEX(239)]) * pres_mod[INDEX(42)];
  //sp 47
  shared_temp[threadIdx.x + 3 * blockDim.x] -= (fwd_rates[INDEX(240)] - rev_rates[INDEX(239)]) * pres_mod[INDEX(42)];
  ...
  //rxn 268
  //sp 45
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(268)] - rev_rates[INDEX(267)]) * pres_mod[INDEX(43)];
  //sp 14
  sp_rates[INDEX(14)] += (fwd_rates[INDEX(268)] - rev_rates[INDEX(267)]) * pres_mod[INDEX(43)];
  //sp 31
  sp_rates[INDEX(31)] += (fwd_rates[INDEX(268)] - rev_rates[INDEX(267)]) * pres_mod[INDEX(43)];
  ...
  //rxn 288
  //sp 0
  sp_rates[INDEX(0)] -= (fwd_rates[INDEX(288)] - rev_rates[INDEX(285)]) * pres_mod[INDEX(44)];
  //sp 9
  sp_rates[INDEX(9)] -= (fwd_rates[INDEX(288)] - rev_rates[INDEX(285)]) * pres_mod[INDEX(44)];
  //sp 12
  sp_rates[INDEX(12)] += (fwd_rates[INDEX(288)] - rev_rates[INDEX(285)]) * pres_mod[INDEX(44)];
  ...
  //rxn 302
  //sp 52
  shared_temp[threadIdx.x] -= fwd_rates[INDEX(302)] * pres_mod[INDEX(45)];
  //sp 13
  sp_rates[INDEX(13)] += fwd_rates[INDEX(302)] * pres_mod[INDEX(45)];
  //sp 14
  shared_temp[threadIdx.x + 2 * blockDim.x] += fwd_rates[INDEX(302)] * pres_mod[INDEX(45)];

  //rxn 303
  sp_rates[INDEX(12)] += shared_temp[threadIdx.x + 3 * blockDim.x];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(303)] - rev_rates[INDEX(291)]) * pres_mod[INDEX(46)];
  //sp 51
  shared_temp[threadIdx.x + 3 * blockDim.x] = (fwd_rates[INDEX(303)] - rev_rates[INDEX(291)]) * pres_mod[INDEX(46)];
  //sp 28
  sp_rates[INDEX(28)] -= (fwd_rates[INDEX(303)] - rev_rates[INDEX(291)]) * pres_mod[INDEX(46)];
  ...
  //sp 25
  sp_rates[INDEX(25)] -= (fwd_rates[INDEX(311)] - rev_rates[INDEX(296)]) * pres_mod[INDEX(47)];
  //sp 50
  shared_temp[threadIdx.x] = (fwd_rates[INDEX(311)] - rev_rates[INDEX(296)]) * pres_mod[INDEX(47)];
  //sp 12
  sp_rates[INDEX(12)] -= (fwd_rates[INDEX(311)] - rev_rates[INDEX(296)]) * pres_mod[INDEX(47)];
  ...
  //rxn 317
  //sp 24
  sp_rates[INDEX(24)] -= (fwd_rates[INDEX(317)] - rev_rates[INDEX(302)]) * pres_mod[INDEX(48)];
  //sp 49
  shared_temp[threadIdx.x + 2 * blockDim.x] += (fwd_rates[INDEX(317)] - rev_rates[INDEX(302)]) * pres_mod[INDEX(48)];
  //sp 12
  sp_rates[INDEX(12)] -= (fwd_rates[INDEX(317)] - rev_rates[INDEX(302)]) * pres_mod[INDEX(48)];
  ...
  //rxn 319
  //sp 49
  shared_temp[threadIdx.x + 2 * blockDim.x] -= (fwd_rates[INDEX(319)] - rev_rates[INDEX(304)]) * pres_mod[INDEX(49)];
  //sp 50
  shared_temp[threadIdx.x] += (fwd_rates[INDEX(319)] - rev_rates[INDEX(304)]) * pres_mod[INDEX(49)];
  //sp 1
  shared_temp[threadIdx.x + 1 * blockDim.x] -= (fwd_rates[INDEX(319)] - rev_rates[INDEX(304)]) * pres_mod[INDEX(49)];
